...
export default {
    ...
    'aelf.SystemSettings': 'System Settings',
    ...
    'aelf.Becareful01': 'Password Requirement: 9 characters at least, must contain a number, an uppercase and lowercase letter, and a symbol.',
    'aelf.Becareful02': "Please note: aelf wallet will not store your password, nor can we help you recover it if it's lost. You should keep your password safe.",
    ...
    'aelf.Import': 'Import',
    'aelf.System Settings': 'System Settings',
    ...
    'aelf.keystoreCon01': 'The Keystore file is a file format (JSON) for storing the private key. It uses user-defined password encryption to protect the wallet to a certain extent, and the degree of protection depends on the password strength of the wallet. If the password is similar to 123456, it is extremely unsafe.',
    'aelf.keystoreCon02': 'So users must pay attention to three points when backing up Keystore:',
    'aelf.keystoreCon03': '1. use encrypted Keystore files that are not commonly used and as complex as possible.',
    'aelf.keystoreCon04': "2. Be sure to remember the password to encrypt Keystore. Once you forget the password, you lose the right to use Keystore, and aelf can't help you retrieve the password. So please keep it safe.",
    'aelf.keystoreCon05': 'Keystore Demo:',
    ...
    'aelf.About AElf Official Wallet': 'About aelf Wallet',
    ...
    'aelf.Notes on cross chain transfer': 'About cross-chain transfer',
